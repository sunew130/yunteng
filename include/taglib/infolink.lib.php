...
function lib_infolink(&$ctag,&$refObj)
{
    ...
    $fields['linkallplace'] = "<a href='{$baseurl}yunteng_cc_plus/list.php?channelid={$channelid}&tid={$typeid}&infotype={$infotype}'>不限</a>";
    $fields['linkalltype'] = "<a href='{$baseurl}yunteng_cc_plus/list.php?channelid={$channelid}&tid={$typeid}&nativeplace={$nativeplace}'>不限</a>";
