...
function GetFormItem($ctag, $admintype='admin')
{
    ...
    else if($fieldType=='img'||$fieldType=='imgfile')
    {
        if($admintype=='diy') {
            ...
            $innertext = "<input type='text' name='$fieldname' id='$fieldname' style='width:300px' class='text' /> <input name='".$fieldname."_bt' type='button' class='inputbut' value='‰Ø¿¿...' onClick=\"SelectImage('form1.$fieldname','big')\" />\r\n";
        }
    }
    else if($fieldType=='media')
    {
        if($admintype=='diy')
        {
            $innertext = "<input type='hidden' name='$fieldname' id='$fieldname' value='' />≤ª÷ß≥÷µƒ¿‡–Õ\r\n";
        }
        else
        {
            $innertext = "<input type='text' name='$fieldname' id='$fieldname' style='width:300px' class='text' /> <input name='".$fieldname."_bt' type='button' class='inputbut' value='‰Ø¿¿...' onClick=\"SelectMedia('form1.$fieldname')\" />\r\n";
        }
    }
    else if($fieldType=='addon')
    {
        ...
        {
            $innertext = "<input type='text' name='$fieldname' id='$fieldname' style='width:300px' class='text' /> <input name='".$fieldname."_bt' type='button' class='inputbut' value='‰Ø¿¿...' onClick=\"SelectSoft('form1.$fieldname')\" />\r\n";
        }
    }
    else if($fieldType=='int'||$fieldType=='float')
    {
        $dfvalue = ($ctag->GetAtt('default')!='' ? $ctag->GetAtt('default') : '0');
        $innertext = "<input type='text' name='$fieldname' id='$fieldname' style='width:100px'  class='intxt' value='$dfvalue' /> (ÃÓ–¥ ˝÷µ)\r\n";
    }
    else
    {
        $dfvalue = ($ctag->GetAtt('default')!='' ? $ctag->GetAtt('default') : '');
...
function GetFormItemValue($ctag, $fvalue, $admintype='admin', $fieldname='')
{
    ...
    else if($ftype=="img")
    {
        ...
        $innertext = "<input type='text' name='$fieldname' value='$fvalue' id='$fieldname' style='width:300px'  class='text' /> <input name='".$fieldname."_bt' class='inputbut' type='button' value='‰Ø¿¿...' onClick=\"SelectImage('form1.$fieldname','big')\" />\r\n";
    }
    ...
    {
        $innertext = "<input type='text' name='$fieldname' value='$fvalue' id='$fieldname' style='width:300px'  class='text' /> <input name='".$fieldname."_bt' class='inputbut' type='button' value='‰Ø¿¿...' onClick=\"SelectMedia('form1.$fieldname')\" />\r\n";
    }
    else if($ftype=="addon")
    {
        $innertext = "<input type='text' name='$fieldname' id='$fieldname' value='$fvalue' style='width:300px'  class='text' /> <input name='".$fieldname."_bt' class='inputbut' type='button' value='‰Ø¿¿...' onClick=\"SelectSoft('form1.$fieldname')\" />\r\n";
    }
    else if($ftype=="int"||$ftype=="float")
    {
        $innertext = "<input type='text' name='$fieldname' id='$fieldname' style='width:100px'  class='intxt' value='$fvalue' /> (ÃÓ–¥ ˝÷µ)\r\n";
    }
    else
    {
