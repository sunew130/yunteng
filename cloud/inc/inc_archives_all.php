...
function GetFormItem($ctag)
{
    ...
    else if($ctag->GetAtt("type")=="datetime")
    {
        ...
        $innertext .= "<input name=\"selPubtime\" type=\"button\" id=\"selkeyword\" value=\"Ñ¡Ôñ\" onClick=\"showCalendar('$fieldname', 'Y-m-d H:i:00', '24');\">";
        $formitem = str_replace("~name~",$ctag->GetAtt('itemname'),$formitem);
        $formitem = str_replace("~form~",$innertext,$formitem);
        return $formitem;
    }
    ...
    {
        $innertext = "<input type='text' name='$fieldname' id='$fieldname' style='width:300'><input name='".$fieldname."_bt' type='button' value='ä¯ÀÀ...' onClick=\"SelectImage('form1.$fieldname','big')\">\r\n";
        $formitem = str_replace("~name~",$ctag->GetAtt('itemname'),$formitem);
        $formitem = str_replace("~form~",$innertext,$formitem);
        return $formitem;
    }
    ...
    {
        $innertext = "<input type='text' name='$fieldname' id='$fieldname' style='width:300'><input name='".$fieldname."_bt' type='button' value='ä¯ÀÀ...' onClick=\"SelectMedia('form1.$fieldname')\">\r\n";
        $formitem = str_replace("~name~",$ctag->GetAtt('itemname'),$formitem);
        $formitem = str_replace("~form~",$innertext,$formitem);
        return $formitem;
    }
    ...
    {
        $innertext = "<input type='text' name='$fieldname' id='$fieldname' style='width:300'><input name='".$fieldname."_bt' type='button' value='ä¯ÀÀ...' onClick=\"SelectSoft('form1.$fieldname')\">\r\n";
        $formitem = str_replace("~name~",$ctag->GetAtt('itemname'),$formitem);
        $formitem = str_replace("~form~",$innertext,$formitem);
        return $formitem;
    }
...
function GetFormItemValue($ctag, $fvalue)
{
    ...
    else if($ctag->GetAtt("type")=="img")
    {
        ...
        $innertext = "<input type='text' name='$fieldname' value='$fvalue' id='$fieldname' style='width:300'><input name='".$fieldname."_bt' type='button' value='ä¯ÀÀ...' onClick=\"SelectImage('form1.$fieldname','big')\">\r\n";
        $formitem = str_replace("~name~",$ctag->GetAtt('itemname'),$formitem);
        $formitem = str_replace("~form~",$innertext,$formitem);
        return $formitem;
    }
    ...
    {
        $innertext = "<input type='text' name='$fieldname' value='$fvalue' id='$fieldname' style='width:300'><input name='".$fieldname."_bt' type='button' value='ä¯ÀÀ...' onClick=\"SelectMedia('form1.$fieldname')\">\r\n";
        $formitem = str_replace("~name~",$ctag->GetAtt('itemname'),$formitem);
        $formitem = str_replace("~form~",$innertext,$formitem);
        return $formitem;
    }
    ...
    {
        $innertext = "<input type='text' name='$fieldname' id='$fieldname' value='$fvalue' style='width:300'><input name='".$fieldname."_bt' type='button' value='ä¯ÀÀ...' onClick=\"SelectSoft('form1.$fieldname')\">\r\n";
        $formitem = str_replace("~name~",$ctag->GetAtt('itemname'),$formitem);
        $formitem = str_replace("~form~",$innertext,$formitem);
        return $formitem;
    }
