...
else if($dopost=="saveedit")
{
	...
	if(!empty($logoimg))
	{
		$request->MoveUploadFile('logoimg', DEDEROOT.'/yunteng_cc_images/flink/'.$request->GetFileInfo('logoimg', 'name'));
		$logo = $cfg_cmspath.'/yunteng_cc_images/flink/'.$request->GetFileInfo('logoimg', 'name');
	}
