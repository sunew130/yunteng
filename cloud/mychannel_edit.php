...
else if($dopost=="exportinok")
{
    ...
    if(!is_array($dtp->CTags)) GotoStaMsg("模型规则不是合法的云腾科技模型规则！");
...
else if($dopost == 'modifysearch')
{
    ...
    } else if ($step == 1)
    {
        ...
        $forms = '<form action="'.$cfg_cmspath.'/yunteng_cc_plus/advancedsearch.php" method="post">';
